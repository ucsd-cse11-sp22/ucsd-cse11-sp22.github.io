...
- **In the CSE Labs**: Watch and follow the instructions from this video: [this video](https://drive.google.com/file/d/1LGvWU4jaMXDam9sGPO6oHXDMpZumOOhC/view). In text form, the instructions are:
  ...
  - Locate your CSE11 account, which you can find using the ACMS account lookup tool:
    ...
    The username starts with "cs11sp22”. You will need to do an initial password
...
If you get stuck at any point, do any one of the following:
  ...
  - [Ask for help!](https://ucsd-cse11-sp22.github.io/staff-and-help.html)

## Running Code

Download the starter code for this assignment by downloading this repository
using the “Download ZIP” button:
[https://github.com/ucsd-cse11-sp22/cse11-pa1-starter](https://github.com/ucsd-cse11-sp22/cse11-pa1-starter)
...
1. A code submission of your program with the methods you wrote for part two, at [PA1 gradescope assignment](https://www.gradescope.com/courses/381041/assignments/1961700/). You should select and upload the files `DesignRecipeExamples.java` and `transcript.txt`
...
For more information about the grading policy, visit the [course syllabus](https://ucsd-cse11-sp22.github.io/syllabus.html).
